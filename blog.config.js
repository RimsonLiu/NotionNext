...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '2f9937503fdf4521b76d5677ebb0e4c8,en:2f9937503fdf4521b76d5677ebb0e4c8',
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '别忘了去码头整点薯条', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://rimson.life', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, 刘口子', // 网站关键词 英文逗号隔开

...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '2f9937503fdf4521b76d5677ebb0e4c8',
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://rimson.life', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '刘口子, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'rimsonliu@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  MAILCHIMP_LIST_ID: process.env.MAILCHIMP_LIST_ID || null, // 开启mailichimp邮件订阅 客户列表ID ，具体使用方法参阅文档 acfbabc15b
  MAILCHIMP_API_KEY: process.env.MAILCHIMP_API_KEY || null, // 开启mailichimp邮件订阅 APIkey 5ed238dbf727f888ef8255211e1fb067-us8
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '刘口子的博客', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:

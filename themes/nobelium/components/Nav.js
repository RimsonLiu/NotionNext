    ...
    <>
      ...
      <div
        ...
        <div className='flex items-center'>
          <SmartLink href='/' aria-label={siteConfig('TITLE')} className='flex items-center'>
            ...
            <p className='logo ml-2 font-medium text-gray-800 dark:text-gray-300 header-name whitespace-nowrap leading-6'>
              {siteConfig('TITLE')}
            </p>
          </SmartLink>
        </div>
...
const NavBar = props => {
  ...
  let links = [
    ...
    // { icon: 'fas fa-rss', name: 'RSS', to: '/rss/feed.xml', show: siteConfig('NOBELIUM_MENU_RSS', null, CONFIG), target:'_blank' }
    // {
    //   id: 2,
    //   name: locale.NAV.RSS,
    //   href: '/feed',
    ...
    //   name: 'RSS',
    //   href: '/rss/feed.xml',
    //   show: siteConfig('NOBELIUM_MENU_RSS')
    // }
  ]
  if (customNav) {
